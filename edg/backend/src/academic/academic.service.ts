...
export class AcademicService {
    ...
    async generateDraftSchedules(assignmentId: string, startDate: Date, lessonsCount: number, durationMinutes: number) {
        // Find the current max lesson_no for published schedules so we don't overlap
        ...
        // Delete stale DRAFT schedules for this assignment before re-generating
